...
exports.directusDataProvider = void 0;
 ...
 * );
 */
var directusDataProvider = function (apiBaseUrl, httpClient) {
    ...
    return ({
        getList: function (resource, params) {
            ...
            var url = "".concat(getDirectusEndpoint(resource, apiBaseUrl), "?").concat((0, query_string_1.stringify)(query));
...
exports.directusDataProvider = directusDataProvider;
